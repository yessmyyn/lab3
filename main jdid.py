...
# Méthode : QIM (Quantization Index Modulation) + DCT 2D
# ============================================================================
...
def generer_watermark(taille, graine=42):
    ...
    Paramètres:
        taille: nombre de bits du watermark
        graine: clé pour la reproductibilité
    """
...
def inserer_watermark_qim(image_dct, watermark, delta=10, cle_secrete=123):
    """
    Insertion du watermark dans les coefficients DCT via QIM
    La sélection des coefficients est pseudo-aléatoire via clé secrète
    Insertion recommandée : coefficients de moyenne fréquence
    """
    ...
    # On sélectionne les coefficients de moyenne fréquence
...
def extraire_watermark_qim(image_dct, taille_watermark, delta=10, cle_secrete=123):
    """
    Extraction du watermark depuis les coefficients DCT
    Utilise la même clé secrète pour la sélection des coefficients
    """
...
# ============================================================================
# 7. CHARGEMENT ET SAUVEGARDE DES IMAGES
# ============================================================================
...
def main():
    ...
    if ber_jpeg < 0.1:
        print("  ✓ Watermark TRÈS ROBUSTE face à la compression JPEG")
    elif ber_jpeg < 0.2:
        print("  ◯ Watermark MODÉRÉMENT ROBUSTE")
    else:
